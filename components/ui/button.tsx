...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-white shadow-brand hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        tenant: "bg-tenant text-white shadow-brand hover:opacity-90 hover:shadow-lg",
        ...
        gradient: "bg-gradient-accent text-white shadow-brand hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
